...
export default function SettingsPage() {
    ...
    return (
        ...
        >
            <div>
                <h1 className="text-heading-s text-[var(--text)]">Settings</h1>
            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                    <div className="flex items-center gap-4">
                        <div className="w-14 h-14 rounded-full bg-[var(--accent)] flex items-center justify-center text-white text-heading-s font-semibold">
                    ...
                    {[
                        ...
                        <div key={label} className="flex items-center justify-between">
                            ...
                            <button
                                ...
                                aria-checked={value}
                                onClick={() => set(!value)}
                                className={`relative w-10 h-6 rounded-full transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] ${
                                    value ? 'bg-[var(--accent)]' : 'bg-[var(--line-strong)]'
                                }`}
                            >
                <span
            ...
            <div className="flex items-center gap-3">
                ...
                <Button
                    variant="ghost"
                    onClick={logout}
                    className="text-[var(--danger)] hover:bg-red-50 flex items-center gap-2"
                >
                    <LogOut size={16} />
                    Sign out
                </Button>
